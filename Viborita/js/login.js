...
const validarCampo = (expresion, input, campo) => {
  if (expresion.test(input.value)) {
    ...
    document
      .querySelector(`#grupo__${campo} .formularioLogin__input-error`)
      .classList.remove("formularioLogin__input-error-activo");
    campos[campo] = true;
  } else {
    document
      .getElementById(`grupo__${campo}`)
    ...
    document
      .querySelector(`#grupo__${campo} .formularioLogin__input-error`)
      .classList.add("formularioLogin__input-error-activo");
    campos[campo] = false;
  }
};
